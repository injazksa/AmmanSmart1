      ...
      <Card className="border-none shadow-lg bg-primary/5">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            نحن نرحب بطلبات الترخيص والاستخدام التجاري. يرجى إرسال طلبك عبر البريد الإلكتروني مع تفاصيل الاستخدام المقترح.
          </p>
          <div className="bg-background p-4 rounded-lg border">
            <p className="text-sm font-semibold">البريد الإلكتروني للاستفسارات:</p>
            <p className="text-sm text-primary font-mono">info@ammansmart.com</p>
          </div>
        </CardContent>
      </Card>
