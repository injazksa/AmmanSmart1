...
const PageMeta = ({
  title,
  description,
  keywords = "عمان الذكية, مدينة ذكية, الأردن, استثمار تقني, نقل ذكي, رؤية عمان 2030, تكنولوجيا, Amman Smart City, Jordan, Smart Mobility, Digital Transformation",
  ogImage = "https://ammansmart.com/images/background/hero-bg.jpg",
  ...
  return (
    <Helmet>
      ...
      <link rel="preload" as="image" href="/images/background/hero-bg.jpg" />
